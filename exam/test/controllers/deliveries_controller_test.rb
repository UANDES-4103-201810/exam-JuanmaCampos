...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { line1: @delivery.line1, line2: @delivery.line2, phone: @delivery.phone } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { line1: @delivery.line1, line2: @delivery.line2, phone: @delivery.phone } }
